...
void APP_Initialize ( void )
{
    ...
    Set_LED_Style(LED_4, LED_NOT_CTRL, 500, 500);
    Set_LED_Style(LED_5, LED_NOT_CTRL, 500, 500);
    Set_LED_Style(LED_6, LED_NOT_CTRL, 500, 500);
    Set_LED_Style(LED_7, LED_NOT_CTRL, 500, 500);
