...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MFB_Pin|BM83_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : P0_0_Pin */
  GPIO_InitStruct.Pin = P0_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(P0_0_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : MFB_Pin BM83_RST_Pin */
  GPIO_InitStruct.Pin = MFB_Pin|BM83_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
