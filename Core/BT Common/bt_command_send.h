...
enum{
	AT_DO_INQUIRY = 0x00,
	AT_CANCEL_INQUIRY = 0x01,
	AT_TX_SOURCE = 0x02,
	AT_APP_MODE = 0x03,
	AT_READ_APP_MODE = 0x04,
	AT_READ_TX_SOURCE = 0x05,
	AT_TX_I2S_SAMPLING = 0x06,
	AT_READ_TX_SAMPLING_RATE = 0x07,
	AT_BLOCK_A2DP_STREAM = 0x08
};
